...
const UserRepairs = () => {
    ...
    const fetchRepairs = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://localhost:7118/api/Repairs/user/${localStorage.getItem('userId')}`);
    ...
    return (<>{ isAuthenticated &&
        <div className="container mx-auto mt-8">
            <h1 className="text-center text-4xl text-gray-600 m-5">User Repairs</h1>
